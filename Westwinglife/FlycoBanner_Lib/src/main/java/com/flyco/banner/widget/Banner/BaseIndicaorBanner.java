...
public abstract class BaseIndicaorBanner<E, T extends BaseIndicaorBanner<E, T>> extends BaseBanner<E, T> {
    ...
    public BaseIndicaorBanner(Context context, AttributeSet attrs, int defStyle) {
        ...
        selectColor = ta.getColor(R.styleable.BaseIndicaorBanner_bib_indicatorSelectColor, Color.parseColor("#999999"));
        unselectColor = ta.getColor(R.styleable.BaseIndicaorBanner_bib_indicatorUnselectColor, Color.parseColor("#dbdbdb"));
