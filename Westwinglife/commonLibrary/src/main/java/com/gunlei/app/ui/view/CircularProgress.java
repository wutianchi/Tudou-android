 ...
 * 
    <xxx.progressbar.CircularProgress
        android:id="@+id/demoLoader"
...
public class CircularProgress extends View {
    ...
    public CircularProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        a.recycle();
        mColors = new int[2];
        mColors[0]=context.getResources().getColor(R.color.gray_black);
        mColors[1]=context.getResources().getColor(R.color.gray_black);
...
//        mColors[3] = context.getResources().getColor(R.color.blue);
    ...
    private void toggleAppearingMode() {
        ...
        if (mModeAppearing) {
            mCurrentColorIndex = ++mCurrentColorIndex % 2;
            mNextColorIndex = ++mNextColorIndex % 2;
