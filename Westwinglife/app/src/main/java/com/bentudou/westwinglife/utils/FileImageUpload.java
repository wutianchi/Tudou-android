...
public class FileImageUpload {
     ...
     * @return 返回响应的内容
     */
    public static String uploadFile(String token,File file,String fileKey, String RequestURL) {
        ...
        try {
            ...
            if(file!=null) {
                ...
                sb.append("Content-Disposition: form-data; name=\"").append("BtdToken").append("\"").append(LINE_END).append(LINE_END);
                sb.append(token).append(LINE_END);
                params = sb.toString();
